...
\begin{frame} [fragile]
    ...
    \begin{itemize}
        ...
        \item \texttt{getMenuOptions()},\texttt{getView()} e \texttt{beforeExecute()} metodi di gancio implementati nella classe figlia \emph{ArticleMVController} con un comportamento specifico
    \end{itemize}
\end{frame}
